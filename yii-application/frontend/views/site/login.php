...
<body>
<div class="login-logo"><h1>秀百贝后台登录系统</h1></div>
<div class="login-box">
    <form class="layui-form layui-form-pane" action="index.php?r=site/login" id="login" method="post">
...
<script src="/layui/ajaxfrom.js"></script>
<script>
    $(function  () {
